...
public class CritterFunctionalTest {
    ...
    @Test
    public void testCreateEmployee() throws UserNotFoundException {
    ...
    @Test
    public void testAddPetsToCustomer() throws PetNotFoundException, UserNotFoundException {
        CustomerDTO customerDTO = createCustomerDTO();
        CustomerDTO newCustomer = userController.saveCustomer(customerDTO);
    ...
    @Test
    public void testFindPetsByOwner() throws UserNotFoundException {
        CustomerDTO customerDTO = createCustomerDTO();
        CustomerDTO newCustomer = userController.saveCustomer(customerDTO);
    ...
    @Test
    public void testFindOwnerByPet() throws UserNotFoundException {
        CustomerDTO customerDTO = createCustomerDTO();
        CustomerDTO newCustomer = userController.saveCustomer(customerDTO);
    ...
    @Test
    public void testChangeEmployeeAvailability() throws UserNotFoundException {
        EmployeeDTO employeeDTO = createEmployeeDTO();
    ...
    @Test
    public void testSchedulePetsForServiceWithEmployee() throws UserNotFoundException {
        ...
        Assertions.assertEquals(scheduleDTO.getUserIds(), employeeList);
        Assertions.assertEquals(scheduleDTO.getPetIds(), petList);
    }

    @Test
    public void testFindScheduleByEntities() throws UserNotFoundException {
        ...
        sched3.setUserIds(sched1.getUserIds());
        ...
        List<ScheduleDTO> scheds1e = scheduleController.getScheduleForEmployee(sched1.getUserIds().get(0));
        compareSchedules(sched1, scheds1e.get(0));
        compareSchedules(sched3, scheds1e.get(1));

        //Employee 2 is only in schedule 2
        List<ScheduleDTO> scheds2e = scheduleController.getScheduleForEmployee(sched2.getUserIds().get(0));
    ...
    private static ScheduleDTO createScheduleDTO(List<Long> petIds, List<Long> employeeIds, LocalDate date, Set<EmployeeSkill> activities) {
        ...
        scheduleDTO.setUserIds(employeeIds);
    ...
    private static void compareSchedules(ScheduleDTO sched1, ScheduleDTO sched2) {
        ...
        Assertions.assertEquals(sched1.getUserIds(), sched2.getUserIds());
